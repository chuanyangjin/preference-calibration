...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_config.model_name_or_path, use_fast=True, cache_dir = "/scratch/vp1271/hf_cache")
    model = AutoModelForSequenceClassification.from_pretrained(
            model_config.model_name_or_path, num_labels=1, cache_dir = "/scratch/vp1271/hf_cache",  **model_kwargs
    )
